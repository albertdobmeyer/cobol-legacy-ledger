...
6. **Testability** — Every requirement must be testable. 820 tests, all green.
...
- `python/tests/` — 820 tests across 29 test files

### Web Console (static HTML/CSS/JS, no Node.js)

- `console/index.html` — SPA shell with nav tabs (Dashboard/Analysis/Mainframe/Chat), role selector, health dot
...
- `console/css/analysis.css` — Call graph, compare viewer, complexity heatmap, paragraph detail, data flow styles
- `console/css/mainframe.css` — COBOL editor, JCL output panel, quick reference sidebar
- `console/css/polish.css` — Fun facts, timeline, onboarding v2, breadcrumbs, tab hints
...
```bash
# Run all 820 tests (or: make test)
